...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    $question = new Question($this->data ['idQuestion'], $this->data ['questionNo'], $this->data ['questionFR'], $this->data ['questionCommentFR'], $this->data ['questionDE'], $this->data ['questionCommentDE'], $this->data ['axes_idAxe']);
