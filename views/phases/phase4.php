...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title><?php echo PHASE4_TITLE; ?></title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><i class="fa fa-pencil"></i> <?php echo PHASE4_PHASE4; ?></h2>   
                        </div>
                    </div> 
                    ...
                    <div class="col-lg-12">
                        <div class="panel-group" id="accordion">
                            ...
                            <?php
                            $questions = phasesController::getQuestionsByNo(5);
                            if ($questions) :
                                        ...
                                        <div class="panel-heading">
                                            ...
                                            <div id="<?php echo 'collapse' . $i; ?>" class="panel-collapse in" style="height: auto;">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    if ($i == $nbrQuestions) :
                                                        ?>
                                                        <a href="<?php echo URL_DIR . 'phases/add?noQuestion=5&phase=4'; ?>" class="btn btn-success"><?php echo PHASE1_ADD; ?></a>
                                                        <a href="<?php echo URL_DIR . 'phases/edit?id=' . $question->getId() . '&phase=4'; ?>" class="btn btn-warning"><?php echo PHASE1_EDIT; ?></a>
                                                        <input type="checkbox" id="<?php echo 'checkb' . $i; ?>"/>
                                                        <input type="button" class="btn btn-danger" name="delete" disabled="disabled" id="<?php echo 'delete' . $i; ?>" onclick="location.href = '<?php echo URL_DIR . 'phases/deleteQuestion?id=' . $question->getId() . '&phase=4'; ?>'" value="<?php echo PHASE1_DELETE; ?>" />
                                                    <?php else : ?>
                                                        <a href="<?php echo URL_DIR . 'phases/edit?id=' . $question->getId() . '&phase=4'; ?>" class="btn btn-warning"><?php echo PHASE1_EDIT; ?></a>
                                                    <?php endif; ?>
                                                </div>
