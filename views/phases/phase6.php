...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title><?php echo PHASE6_TITLE; ?></title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2><i class="fa fa-plus-circle"></i> <?php echo PHASE6_PHASE6; ?></h2>   
                        </div>
                    </div> 
                    ...
                    <div class="col-lg-12">
                        <div class="panel-group" id="accordion">
                            ...
                            <?php
                            $questions = phasesController::getQuestionsByNo(8);
                                    ...
                                    <div id="<?php echo 'collapse' . $i; ?>" class="panel-collapse in" style="height: auto;">
                                        <div class="panel-body">
                                            <?php 
                                                ...
                                                if ($i == $nbrQuestions1) : ?>
                                                    <a href="<?php echo URL_DIR . 'phases/add?noQuestion=8&phase=6'; ?>" class="btn btn-success"><?php echo PHASE1_ADD; ?></a>
                                                    <a href="<?php echo URL_DIR . 'phases/edit?id=' . $question->getId() . '&phase=6'; ?>" class="btn btn-warning"><?php echo PHASE1_EDIT; ?></a>
                                                    <input type="checkbox" id="<?php echo 'checkb' . $i; ?>"/>
                                                    <input type="button" class="btn btn-danger" name="delete" disabled="disabled" id="<?php echo 'delete' . $i; ?>" onclick="location.href='<?php echo URL_DIR . 'phases/deleteQuestion?id=' . $question->getId() . '&phase=6'; ?>'" value="<?php echo  PHASE1_DELETE; ?>" />
                                                <?php else : ?>
                                                    <a href="<?php echo URL_DIR . 'phases/edit?id=' . $question->getId() . '&phase=6'; ?>" class="btn btn-warning"><?php echo PHASE1_EDIT; ?></a>
                                                <?php endif; ?>
                                        </div>
                            ...
                            <?php
                            $questions = phasesController::getQuestionsByNo(9);
                                    ...
                                    <div class="panel-body">
                                        <?php 
                                            ...
                                            if ($i-50 == $nbrQuestions2) : ?>
                                                <a href="<?php echo URL_DIR . 'phases/add?noQuestion=9&phase=6'; ?>" class="btn btn-success"><?php echo PHASE1_ADD; ?></a>
                                                <a href="<?php echo URL_DIR . 'phases/edit?id=' . $question->getId() . '&phase=6'; ?>" class="btn btn-warning"><?php echo PHASE1_EDIT; ?></a>
                                                <input type="checkbox" id="<?php echo 'checkb' . $i; ?>"/>
                                                <input type="button" class="btn btn-danger" name="delete" disabled="disabled" id="<?php echo 'delete' . $i; ?>" onclick="location.href='<?php echo URL_DIR . 'phases/deleteQuestion?id=' . $question->getId() . '&phase=6'; ?>'" value="<?php echo  PHASE1_DELETE; ?>" />
                                            <?php else : ?>
