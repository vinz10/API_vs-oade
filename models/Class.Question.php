...
class Question {
    ...
    /**
      ...
      // @desc Method that get a question by the no from the DB
      // @param int $no
      // @return Questions
     */
    public static function getQuestionsByNo($no) {
        ...
        foreach ($rows as $row) {
            $question = new Question($row['idQuestion'], $row['questionNo'], $row['questionFR'], $row['questionCommentFR'], $row['questionDE'], 
                    $row['questionCommentDE'], $row['axes_idAxe']);
    ...
    /**
      ...
      // @desc Method that get a question by the idQuestion from the DB
      // @param int $idQuestion
      // @return Question
     */
    public static function getQuestionById($idQuestion) {
        ...
        return new Question($row['idQuestion'], $row['questionNo'], $row['questionFR'], $row['questionCommentFR'], $row['questionDE'], 
                $row['questionCommentDE'], $row['axes_idAxe']);
    }

    /**
      // @method getLastNo()
      // @desc Method that get the last questionNo by idPhase
      // @param int $idPhase
      // @return int lastNo
     */
    ...
    /**
      ...
      // @desc Method that update a question into the DB by the idQuestion
      // @param int $idQuestion
      // @return PDOStatement
     */
    ...
    /**
      ...
      // @desc Method that delete a question by the idQuestion
      // @param int $idQuestion
     */
